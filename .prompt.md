...
if the conversation is on topic, i want to not trigger anything by Lumina, Lumina will be silent unless there is a severe or warning intervention.

how to accomplish this? write in terms of steps, be technical, No code.
