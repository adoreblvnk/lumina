...
in discussion view, when transcribing the conversation, it still transcribes in other languages eg
```
I don't think so-

They should be forced to wear school uniforms.
...
Bravo.
```
i have alr set the language to english, what else can i do
